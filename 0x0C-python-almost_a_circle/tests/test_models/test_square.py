...
class TestSquare(unittest.TestCase):
    """represents the test cases for Square class."""
    ...
    def setUp(self):
        ...
        self.r4 = Square(2)
        self.r5 = Square(2, 2, 2)
        self.r6 = Square(10, 10, 10)
    ...
    def test_heightsetter(self):
        """test cases for Square setter methods"""
        with self.assertRaises(TypeError):
            self.r1.height = "2"
    ...
    def test_sizesetter(self):
        ...
        with self.assertRaises(TypeError):
            self.r1.size = "2"
            self.r1.size = {"2", "e", "l"}
            self.r1.size = [1, 2, 3, ["my guy"]]
            self.r1.size = {}
            self.r1.size = [23, 45, 32]
    ...
    def test_str(self):
        ...
        case1 = f"[Square] ({self.r1.id}) {self.r1.x}/{self.r1.y} \
- {self.r1.size}\n"
        case2 = f"[Square] ({self.r3.id}) {self.r3.x}/{self.r3.y} \
- {self.r3.size}\n"
        case3 = f"[Square] ({self.r5.id}) {self.r5.x}/{self.r5.y} \
- {self.r5.size}\n"
